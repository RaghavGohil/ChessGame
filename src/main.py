...
initialized_font = pygame.font.SysFont(l_settings.font_name_path , l_settings.font_size)
...
def main():
    ...
    l_in_game_locator.render_current_in_game_location(screen,initialized_font,board,l_colors.current_location_font_bounding_box_color,l_colors.current_location_font_color,winw,winh,l_settings.font_antialiasing)
